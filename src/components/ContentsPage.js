...
export default class Content extends Component {
  ...
  contentList = () => {
    return this.items.map((item, i) => (
      <Fragment key={i}>
        <i className="ui orange right ribbon label align centered">
        ...
        <Card
          ...
          onClick={this.gotoContent.bind(this, item)}
        />
      </Fragment>
    ));
  };
        ...
        <div id="cardPadding">
          <Container>
            <div className="ui centered align grid">
              <h2 id="textStyle">Crowd Sourcing: Questions Curations</h2>
            </div>
            <Card.Group>{this.contentList()}</Card.Group>
          </Container>
        </div>
      </div>
    );

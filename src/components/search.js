...
<div className="ui middle aligned stackable grid container">
  <div className="row">
    ...
    <div className="six wide right floated column">
      <img className="ui large bordered rounded image" src="https://ak7.picdn.net/shutterstock/videos/13351367/thumb/1.jpg" />
    </div>
  </div>
  <div className="row">
    <div className="center aligned column">
      <a className="ui huge button"   onClick={this.createContent}>Start creating story</a>
    </div>
  </div>
</div>
</div>
